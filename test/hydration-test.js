...
describe('Hydration', function () {
  ...
  it('should find the average water intake per day for a user', function () {
    expect(hydration.getAvg('numOunces', 3)).to.equal(2);
  });

  it.skip('should find the water intake for a user on a specified date', function () {
  ...
  it.skip('should find water intake by day for first week', function () {
    ...
    expect(hydration.calculateFirstWeekOunces(userRepo, 4)[0]).to.eql(
      '2019/09/20: 40'
    );
    expect(hydration.calculateFirstWeekOunces(userRepo, 4)[6]).to.eql(
      '2019/04/15: 36'
    );
  });
  ...
  it.skip('should find sleep quality by day for that days week', function () {
    ...
    expect(
      hydration.calculateRandomWeekOunces('2019/09/18', 4, userRepo)[0]
    ).to.eql('2019/09/18: 40');
